...
- neviweb130.set_wifi_floor_limit_low to set minimum setpoint temperature for wifi floor thermostats. (5 to 34 oC)
- neviweb130.set_wifi_floor_limit_high to set maximum setpoint temperature for wifi floor thermostats. (7 to 36 oC)
