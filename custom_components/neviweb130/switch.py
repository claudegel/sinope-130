...
from .const import (ATTR_ACTIVE, ATTR_AWAY_ACTION, ATTR_BATT_INFO,
                    ...
                    ATTR_INPUT_NUMBER, ATTR_INPUT_STATUS, ATTR_KEYPAD,
                    ATTR_LEAK_CLOSURE_CONFIG, ATTR_LEG_PROTEC_STATUS,
                    ATTR_LOW_TEMP_STATUS, ATTR_MIN_WATER_TEMP, ATTR_NAME_1,
                    ATTR_NAME_2, ATTR_ONOFF, ATTR_ONOFF2, ATTR_ONOFF_NUM,
                    ATTR_OPTOUT, ATTR_OUTPUT_NAME_1, ATTR_OUTPUT_NAME_2,
                    ATTR_REL_HUMIDITY, ATTR_ROOM_TEMPERATURE, ATTR_RSSI,
                    ATTR_STATUS, ATTR_SYSTEM_MODE, ATTR_TANK_SIZE,
                    ...
                    ATTR_WATER_LEAK_STATUS, ATTR_WATER_TANK_ON,
                    ATTR_WATER_TEMP_MIN, ATTR_WATER_TEMP_PROTECT,
                    ATTR_WATER_TEMP_TIME, ATTR_WATER_TEMPERATURE,
                    ATTR_WATT_TIME_ON, ATTR_WATTAGE, ATTR_WATTAGE_INSTANT,
                    ATTR_WIFI, ATTR_WIFI_KEYPAD, ATTR_WIFI_WATT_NOW,
                    ...
                    SERVICE_SET_SWITCH_TEMP_ALERT, SERVICE_SET_SWITCH_TIMER,
                    SERVICE_SET_SWITCH_TIMER_2, SERVICE_SET_TANK_SIZE,
                    STATE_KEYPAD_STATUS, STATE_WATER_LEAK, VERSION)
...
from .schema import (SET_ACTIVATION_SCHEMA, SET_CONTROL_ONOFF_SCHEMA,
                     ...
                     SET_SWITCH_TEMP_ALERT_SCHEMA, SET_SWITCH_TIMER_2_SCHEMA,
                     SET_SWITCH_TIMER_SCHEMA, SET_TANK_SIZE_SCHEMA)
...
class Neviweb130Switch(SwitchEntity):
    ...
    def __init__(self, device_info, name, sku, firmware, device_type, client):
        ...
        self._keypad = None
        self._mark: float | int = 0
        self._marker: float | int | None = None
