...
class Neviweb130Thermostat(ClimateEntity):
    ...
    def update(self):
        ...
        if self._is_hc:
            HC_ATTRIBUTE = [ATTR_COOL_SETPOINT, ATTR_COOL_SETPOINT_MIN, ATTR_COOL_SETPOINT_MAX, ATTR_SYSTEM_MODE, ATTR_HC_DEV, ATTR_FAN_SPEED, ATTR_FAN_SWING_VERT, ATTR_CYCLE, ATTR_WATTAGE, ATTR_BACKLIGHT, ATTR_KEYPAD, ATTR_RSSI,
                           ATTR_LANGUAGE, ATTR_DISPLAY2, ATTR_BALANCE_PT, ATTR_DISPLAY_CONF, ATTR_HEAT_LOCK_TEMP, ATTR_COOL_LOCK_TEMP, ATTR_AVAIL_MODE, ATTR_FAN_CAP, ATTR_FAN_SWING_CAP, ATTR_FAN_SWING_CAP_HORIZ, ATTR_FAN_SWING_CAP_VERT, ATTR_ERROR_CODE_SET1]
        else:
            HC_ATTRIBUTE = []
