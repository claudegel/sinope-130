...
from .const import (ATTR_ACCESSORY_TYPE, ATTR_ACTIVE, ATTR_AIR_ACTIVATION_TEMP,
                    ...
                    ATTR_COOL_SETPOINT_MIN, ATTR_CYCLE_LENGTH,
                    ...
                    ATTR_FAN_SPEED, ATTR_FAN_SPEED_OPTIM, ATTR_FAN_SWING_CAP,
                    ...
                    ATTR_HEAT_COOL, ATTR_HEAT_INSTALLATION_TYPE,
                    ATTR_HEAT_INTERSTAGE_MIN_DELAY, ATTR_HEAT_LOCK_TEMP,
                    ATTR_HEAT_LOCKOUT_TEMP, ATTR_HEAT_MIN_TIME_OFF,
                    ATTR_HEAT_MIN_TIME_ON, ATTR_HEAT_OUTPUT_POLARITY,
                    ATTR_HEAT_PURGE_TIME, ATTR_HEAT_SOURCE_TYPE,
                    ATTR_HEATCOOL_SETPOINT_MIN_DELTA, ATTR_HUMIDIFIER_TYPE,
                    ATTR_HUMIDITY_DISPLAY, ATTR_HUMIDITY_SETPOINT,
                    ATTR_HUMIDITY_SETPOINT_MODE, ATTR_HUMIDITY_SETPOINT_OFF,
                    ATTR_HUMIDITY_SETPOINT_OFFSET, ATTR_HVAC_INPUT_1_FUNCTION,
                    ATTR_INTERLOCK_HC_MODE, ATTR_INTERLOCK_ID,
                    ATTR_INTERLOCK_PARTNER, ATTR_KEYPAD, ATTR_LANGUAGE,
                    ATTR_MODE, ATTR_MODEL, ATTR_OCCUPANCY, ATTR_OPTOUT,
                    ATTR_OUTPUT1, ATTR_OUTPUT_CONNECT_STATE,
                    ATTR_OUTPUT_PERCENT_DISPLAY, ATTR_POLARITY,
                    ATTR_PUMP_PROTEC, ATTR_PUMP_PROTEC_DURATION,
                    ATTR_PUMP_PROTEC_PERIOD, ATTR_REVERSING_VALVE_POLARITY,
                    ...
                    ATTR_SCHEDULED_PEAK_DELAY, ATTR_SETPOINT,
                    ATTR_SETPOINT_MODE, ATTR_SOUND_CAP, ATTR_SOUND_CONF,
                    ATTR_STATUS, ATTR_SYSTEM_MODE, ATTR_SYSTEM_MODE_AVAIL,
                    ATTR_TEMP, ATTR_TEMP_OFFSET_HEAT, ATTR_TIME,
                    ATTR_TIME_FORMAT, ATTR_TYPE, ATTR_VALUE, ATTR_WATTAGE,
                    ATTR_WIFI, ATTR_WIFI_KEYPAD, ATTR_WIFI_WATTAGE, DOMAIN,
                    ...
                    SERVICE_SET_ROOM_SETPOINT_AWAY, SERVICE_SET_SCHEDULE_MODE,
...
from .schema import (AUX_HEATING, CYCLE_LENGTH_VALUES, FAN_SPEED,
                     FAN_SPEED_VALUES, FAN_SPEED_VALUES_5, FULL_SWING,
                     FULL_SWING_OFF, HP_FAN_SPEED, NEVIWEB_MODE_MAP,
                     ...
                     SET_ROOM_SETPOINT_AWAY_SCHEMA, SET_SCHEDULE_MODE_SCHEMA,
                     ...
                     TH6_MODES_VALUES, WIFI_FAN_SPEED)
...
class Neviweb130WifiHPThermostat(Neviweb130Thermostat):
    ...
    def set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        # Send heatCoolMode (because self._is_WHP = True)
        self._client.set_setpoint_mode(self._id, mode, self._is_wifi, self._is_WHP)
    ...
    def set_preset_mode(self, preset_mode: str) -> None:
        ...
        if preset_mode in (PRESET_HOME, PRESET_AWAY, PRESET_NONE):
            self._client.set_occupancy_mode(self._id, preset_mode, self._is_wifi)
            self._occupancy = preset_mode
        ...
        # --- SetpointMode presets (manual / schedule (auto)) ---
            ...
            self._client.set_setpoint_mode(self._id, "manual", self._is_wifi, False)
            # IMPORTANT: do not change self._occupancy

        elif preset_mode == PRESET_SCHEDULE:
            self._client.set_setpoint_mode(self._id, "auto", self._is_wifi, False)
            # IMPORTANT: do not change self._occupancy
    ...
    def set_temperature(self, **kwargs: Any) -> None:
        ...
        if mode in (HVACMode.HEAT, HVACMode.HEAT_COOL, HVACMode.AUTO):
            self._client.set_temperature(self._id, temp)

        # COOL → cooling setpoint
        elif mode == HVACMode.COOL:
            self._client.set_cool_temperature(self._id, temp)
