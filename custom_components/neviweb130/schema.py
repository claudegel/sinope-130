...
from .const import (ATTR_ACTIVE, ATTR_AUX_HEAT_TIMEON, ATTR_BACKLIGHT,
                    ...
                    ATTR_COOL_SETPOINT_MIN, ATTR_DISPLAY2,
                    ATTR_DISPLAY_CONF, ATTR_DRACTIVE, ATTR_EARLY_START,
                    ATTR_FLOOR_AIR_LIMIT, ATTR_FLOOR_MAX, ATTR_FLOOR_MIN,
                    ATTR_FLOOR_MODE, ATTR_FLOOR_SENSOR,
                    ATTR_FLOW_ALARM1_PERIOD, ATTR_FLOW_MODEL_CONFIG,
                    ATTR_FUEL_ALERT, ATTR_FUEL_PERCENT_ALERT, ATTR_GAUGE_TYPE,
                    ATTR_GREEN, ATTR_HEAT_LOCK_TEMP, ATTR_INTENSITY, ATTR_KEY_DOUBLE_UP, ATTR_KEYPAD,
                    ATTR_LANGUAGE, ATTR_LEAK_ALERT, ATTR_LIGHT_WATTAGE,
                    ATTR_MODE, ATTR_NAME_1, ATTR_NAME_2, ATTR_ONOFF,
                    ATTR_ONOFF_NUM, ATTR_OPTOUT, ATTR_OUTPUT_NAME_1,
                    ATTR_OUTPUT_NAME_2, ATTR_PHASE_CONTROL, ATTR_POWER_SUPPLY,
                    ATTR_RED, ATTR_ROOM_SETPOINT_MAX, ATTR_ROOM_SETPOINT_MIN,
