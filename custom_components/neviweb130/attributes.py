...
from .const import (ATTR_BATT_ALERT, ATTR_BATTERY_STATUS, ATTR_BATTERY_VOLTAGE,
                    ...
                    ATTR_LIGHT_WATTAGE, ATTR_PHASE_CONTROL, ATTR_RSSI,
                    ATTR_TEMP_ALARM, ATTR_TIMER, ATTR_WATER_LEAK_STATUS,
                    ATTR_WATTAGE_INSTANT, ATTR_WIFI)
...
SENSOR_DEVICE_MODEL_NEW_DIMMER = [
    ATTR_PHASE_CONTROL,
    ATTR_KEY_DOUBLE_UP,
...
SENSOR_WIFI_MESH_VALVE_MODEL_ATTRIBUTE = [
    ATTR_TEMP_ALARM,
    ATTR_BATTERY_STATUS,
...
SENSOR_ZB_MESH_VALVE_MODEL_ATTRIBUTE = [
    ATTR_BATTERY_VOLTAGE,
    ATTR_BATTERY_STATUS,
    ATTR_WATER_LEAK_STATUS,
]
...
SENSOR_WIFI_VALVE_MODEL_ATTRIBUTE = [
    ATTR_TEMP_ALARM,
    ATTR_BATTERY_VOLTAGE,
    ATTR_BATTERY_STATUS,
    ATTR_WATER_LEAK_STATUS,
