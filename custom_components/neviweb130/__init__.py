    ...
    def __init__(self, hass, config):
        ...
        if CONF_ACCOUNTS in config:
            ...
            for account in accounts:
                ...
                client = Neviweb130Client(hass, username, password, location, None, None, ignore_miwi)
        ...
        # Legacy single-account format (backward compatibility)
            ...
            client = Neviweb130Client(hass, username, password, network, network2, network3, ignore_miwi)
